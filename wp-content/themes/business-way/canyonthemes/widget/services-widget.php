 ...
 * @since 1.0.0
 */
if( !class_exists( 'Business_Way_Services_Widget' ) ){

  class Business_Way_Services_Widget extends WP_Widget

  {
    private function defaults()
    {
      ...
      $defaults    = array(
        'title'               => esc_html__('Our Services','business-way'),
        'sub_title'           => esc_html__('Check Our All Services','business-way'),
        'features'            => ''
      );
      return $defaults;
    }
...

    {
      parent::__construct(
        ...
        'business_way_service_widget',
        /*Widget name will appear in UI*/
        esc_html__( 'Business Way Services', 'business-way' ),
        /*Widget description*/
        array( 'description' => esc_html__( 'Business Way Service Section', 'business-way' ) )
      );
    }
        /**
                        ...
                        if ( $services_query->have_posts() ):
                          ...
                          while ( $services_query->have_posts() ):$services_query->the_post();
                            ...
                            <div class="col-md-4 col-sm-6">
                              <div class="services-block wow fadeInUp" data-wow-delay=".<?php echo esc_attr($i); ?>s">
        ...
        public function form($instance)
        {
          ...
          <span class="pt-business-way-additional services">
            ...
            <a class="pt-business-way-add button" data-id="business_way_service_widget" id="<?php echo $repeater_id; ?>"><?php _e('Add New Section', 'business-way'); ?></a> 
            <?php
          }
        }
      }
      add_action( 'widgets_init', 'business_way_service_widget' );
      function business_way_service_widget() {
        register_widget( 'Business_Way_Services_Widget' );
      }