...
window.averta = {},
    ...
    function() {
        ...
        window.CTween = {}, CTween.setPos = function(element, pos) {
            ...
            reset !== !1 && target.css("opacity", 1).css("display", "block"), CTween.animate(target, duration || 1e3, {
                opacity: 1
            })
        }
    }(),
    ...
    function($) {
        ...
        p.setup = function() {
            ...
            return fast ? (this.$prev.css("opacity", 1).css("display", "block"), void this.$next.css("opacity", 1).css("display", "block")) : (CTween.fadeOut(this.$prev, 400, !1), CTween.fadeOut(this.$next, 400, !1), this.$prev.addClass("ms-ctrl-hide"), void this.$next.addClass("ms-ctrl-hide"))
        }, p.visible = function() {
